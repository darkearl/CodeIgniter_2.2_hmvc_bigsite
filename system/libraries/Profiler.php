...
class CI_Profiler {
    ...
    {
        $output  = "\n\n";
		$output .= '<fieldset id="ci_profiler_info" style="border:1px solid #00F;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee">';
		$output .= "\n";
		$output .= '<legend style="color:#00F;">&nbsp;&nbsp;INFO&nbsp;&nbsp;</legend>';
		$output .= "\n";
		$output .= "\n\n<table style='width:100%'>\n";

        $output .= "<tr><td style='padding:5px;width:50%;color:#000;font-weight:bold;background-color:#ddd;'>Version Codeigniter&nbsp;&nbsp;</td><td style='padding:5px;width:50%;color:#00F;font-weight:normal;background-color:#ddd;'>".CI_VERSION."</td></tr>\n";
        $output .= "<tr><td style='padding:5px;width:50%;color:#000;font-weight:bold;background-color:#ddd;'>Environment&nbsp;&nbsp;</td><td style='padding:5px;width:50%;color:#00F;font-weight:normal;background-color:#ddd;'>".ENVIRONMENT."</td></tr>\n";
        $output .= "<tr><td style='padding:5px;width:50%;color:#000;font-weight:bold;background-color:#ddd;'>Current PHP version&nbsp;&nbsp;</td><td style='padding:5px;width:50%;color:#00F;font-weight:normal;background-color:#ddd;'>".phpversion()."</td></tr>\n";
		$output .= "</table>\n";
		$output .= "</fieldset>";
